set SynModuleInfo {
  {SRCNAME data_to_axis MODELNAME data_to_axis RTLNAME conv2d_stream_data_to_axis}
  {SRCNAME conv2d_stream_Pipeline_each_image_row MODELNAME conv2d_stream_Pipeline_each_image_row RTLNAME conv2d_stream_conv2d_stream_Pipeline_each_image_row
    SUBMODULES {
  ...
  {SRCNAME conv2d_stream MODELNAME conv2d_stream RTLNAME conv2d_stream IS_TOP 1
    SUBMODULES {
      {MODELNAME conv2d_stream_linebuf_V_0 RTLNAME conv2d_stream_linebuf_V_0 BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
