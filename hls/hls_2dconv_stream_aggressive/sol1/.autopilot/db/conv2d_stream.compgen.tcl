...
set ID 618
set hasByteEnable 0
set MemName conv2d_stream_linebuf_V_0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 619 \
			corename conv2d_stream_CTRL_axilite \
			name conv2d_stream_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler conv2d_stream_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 628
set RegSliceName conv2d_stream_regslice_both
set RegSliceInstName conv2d_stream_regslice_both_U
set CoreName ap_simcore_conv2d_stream_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
