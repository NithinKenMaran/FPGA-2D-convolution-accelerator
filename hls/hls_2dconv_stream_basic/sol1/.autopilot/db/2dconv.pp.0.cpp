...
# 24 "./2dconv.h"
__attribute__((sdx_kernel("conv2d_stream", 0))) void conv2d_stream(
...
#pragma HLS TOP name=conv2d_stream
# 27 "2dconv.cpp"
...
each_image_row:
    for (int img_r = 0; img_r < (64 + 3 - 1); img_r++) {
#pragma HLS UNROLL factor=1
# 67 "2dconv.cpp"

    linebuf_left_to_right:
        for (int ptr = 0; ptr < (64 + 3 - 1); ptr++) {
#pragma HLS UNROLL factor=1
# 69 "2dconv.cpp"
...
# 82 "2dconv.cpp"
            ...
            axis_t out_pkt = data_to_axis(acc, out_count == ((64 + 3 - 1) * (64 + 3 - 1)) - 1);
