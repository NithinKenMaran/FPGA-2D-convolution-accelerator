...
set Vendor      "ee5332"
set Library     "hls"
set IPName      "conv2d_stream"
set Version     "1.0"
set DisplayName "Conv2d_stream"
set Revision    "2114583174"
set Description "Streaming 2D convolution accelerator (pipelined)"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "conv2d_stream"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/kenny/vitis_ws/2dconvolution-64x64/course-project/hls/hls_2dconv_stream_pipelined/sol1"
set debug_dir "/home/kenny/vitis_ws/2dconvolution-64x64/course-project/hls/hls_2dconv_stream_pipelined/sol1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {conv2d_stream_mul_32s_32s_32_2_1
conv2d_stream_flow_control_loop_pipe_sequential_init
conv2d_stream_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 k00 W 0x0 "Data signal of k00" {{0 32 k00 W 0 "Bit 31 to 0 of k00"}}} {0x18 k01 W 0x0 "Data signal of k01" {{0 32 k01 W 0 "Bit 31 to 0 of k01"}}} {0x20 k02 W 0x0 "Data signal of k02" {{0 32 k02 W 0 "Bit 31 to 0 of k02"}}} {0x28 k10 W 0x0 "Data signal of k10" {{0 32 k10 W 0 "Bit 31 to 0 of k10"}}} {0x30 k11 W 0x0 "Data signal of k11" {{0 32 k11 W 0 "Bit 31 to 0 of k11"}}} {0x38 k12 W 0x0 "Data signal of k12" {{0 32 k12 W 0 "Bit 31 to 0 of k12"}}} {0x40 k20 W 0x0 "Data signal of k20" {{0 32 k20 W 0 "Bit 31 to 0 of k20"}}} {0x48 k21 W 0x0 "Data signal of k21" {{0 32 k21 W 0 "Bit 31 to 0 of k21"}}} {0x50 k22 W 0x0 "Data signal of k22" {{0 32 k22 W 0 "Bit 31 to 0 of k22"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 9981 II x}
